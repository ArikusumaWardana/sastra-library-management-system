...
@section('page-subtitle', 'Manage and organize your users')
...
@section('content')
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-2">Organize and manage users for your library collection</p>
        </div>
        
        <!-- Create User Button -->
        <a href="{{ route('users.create') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                    ...
                    @forelse($users as $user)
                        <tr class="hover:bg-amber-50/50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 max-w-xs">
                                <p class="truncate">{{ $user->email ?? 'No email' }}</p>
                            </td>
                            ...
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-600 mb-6 max-w-md">
                                        Get started by creating your first user. Users help organize your library collection efficiently.
                                    </p>
