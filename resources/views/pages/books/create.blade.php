...
@section('page-subtitle', 'Add a new book to your library collection')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Create New Book</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-3 mb-4">
            <div class="h-12 w-12 bg-gradient-to-br from-amber-600 to-orange-600 rounded-full flex items-center justify-center shadow-lg">
                <i class="fas fa-book-plus text-white text-lg"></i>
            </div>
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Create New Book</h1>
                <p class="text-gray-600 mt-1">Add a new book to expand your library collection</p>
            </div>
        </div>
    </div>
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-amber-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <!-- Remove Image Button -->
                            <button type="button" id="removeImageBtn" class="w-full px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 font-medium rounded-lg transition-colors duration-200 hidden" onclick="removeBookImage()">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-amber-100 overflow-hidden">
                    ...
                    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="Fiction" {{ old('book_genre') == 'Fiction' ? 'selected' : '' }}>Fiction</option>
                                    <option value="Non-Fiction" {{ old('book_genre') == 'Non-Fiction' ? 'selected' : '' }}>Non-Fiction</option>
                                    <option value="Mystery" {{ old('book_genre') == 'Mystery' ? 'selected' : '' }}>Mystery</option>
                                    <option value="Romance" {{ old('book_genre') == 'Romance' ? 'selected' : '' }}>Romance</option>
                                    <option value="Sci-Fi" {{ old('book_genre') == 'Sci-Fi' ? 'selected' : '' }}>Science Fiction</option>
                                    <option value="Fantasy" {{ old('book_genre') == 'Fantasy' ? 'selected' : '' }}>Fantasy</option>
                                    <option value="Biography" {{ old('book_genre') == 'Biography' ? 'selected' : '' }}>Biography</option>
                                    <option value="History" {{ old('book_genre') == 'History' ? 'selected' : '' }}>History</option>
                                    <option value="Self-Help" {{ old('book_genre') == 'Self-Help' ? 'selected' : '' }}>Self-Help</option>
                                    <option value="Educational" {{ old('book_genre') == 'Educational' ? 'selected' : '' }}>Educational</option>
                                </select>
                                @error('book_genre')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="mt-6">
                            ...
                            >{{ old('book_description') }}</textarea>
                            @error('book_description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">
                                <span id="descCount">0</span>/1000 characters (Optional)
                            </p>
                        </div>
        ...
        function previewBookImage(input) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    if (previewImage && placeholderContent) {
