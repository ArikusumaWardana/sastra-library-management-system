...
@section('page-subtitle', 'Edit user information to manage your library system')
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-3 mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Edit user information to manage access to your library system</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                <span id="firstNameCount">{{ strlen($user->first_name) }}</span>/50 characters
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">
                                <span id="lastNameCount">{{ strlen($user->last_name) }}</span>/50 characters
                            </p>
                        </div>
                        ...
                        <div>
                            <label for="password" class="block text-sm font-semibold text-gray-700 mb-2">
                                <span class="flex items-center">
                                    ...
                                    Password
                                    <span class="text-amber-600 ml-1 text-xs">(Optional)</span>
                                </span>
                            </label>
                            <input 
                                type="password" 
                            ...
                            @error('password')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Leave empty to keep current password, or enter min. 8 characters</p>
                        </div>
