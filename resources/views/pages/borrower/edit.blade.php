...
@section('page-subtitle', 'Edit a borrower to organize your library collection')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Borrower</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-3 mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Edit a borrower to register them in your library system</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div>
            <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-amber-100 overflow-hidden">
                ...
                <!-- Form Content -->
                <form action="{{ route('borrowers.update', $borrower->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
